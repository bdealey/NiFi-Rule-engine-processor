...
@SideEffectFree
@Tags({"Stateful Rule Engine","Processor","Drools","drl","USCIS","MatrixBI"})
@CapabilityDescription("Stateful Rule engine for nifi")
@Description("This is the stateful rule engien")
public class StatefulRuleEngineProcessor extends AbstractProcessor {
    ...
    protected void init(final ProcessorInitializationContext context) {
    	log = getLogger();
    	log.debug("Init MatrixBI's Stateful RuleEngineProcesor");
